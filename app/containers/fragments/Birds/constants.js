...
export const BIRD_WEIGHT = 30;
export const BIRD_RANDOM_MAX_ANGLE = 10;
export const ALIGNMENT_WEIGHT = 20;
// this constant defines how many birds are influencing a specific one's angle
export const NEAREST_INFLUENCABLE_COUNT = 4;
...
export const MOVE_BIRD = 'MOVE_BIRD';
