...
import { loop, computeNextSlice, createBird, moveBird } from './actions';
import {
  selectLastBirdId,
...
/**
 * Compute everything for a slice of the birds
 */
export function* computeNextSliceSaga() {
  ...
  let movedBirds = birds.slice(sliceStart, sliceStart + SLICE_SIZE).map(b => {
